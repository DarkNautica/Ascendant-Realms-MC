...
- `mobhealthbar-client.toml` tunes YDM's MobHealthBar for K: no proximity-only bars, show bars only for hovered, damaged, or aggressive mobs, and leave true bosses to Enhanced Boss Bars.
